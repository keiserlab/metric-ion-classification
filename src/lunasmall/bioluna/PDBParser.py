...
from Bio.PDB.PDBParser import PDBParser as BioPDBParser
...
class PDBParser(BioPDBParser):
    ...
    def __init__(self, PERMISSIVE=True, get_header=False,
        ...
        super().__init__(PERMISSIVE, get_header, structure_builder, QUIET)
        self.conects = None
